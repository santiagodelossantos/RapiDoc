  ...
  <section id='auth' part="section-auth" style="text-align:left; direction:ltr; margin-top:24px; margin-bottom:24px;" class = 'observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap "}'>
    ...
    <div class="small-font-size" style="display:flex; align-items: center; min-height:30px">
      ${t.length>0?D`
          ...
          <button class="m-btn thin-border" part="btn btn-outline" @click=${()=>{GP.call(this)}}>CLEAR ALL API KEYS</button>`:D`<div class="red-text">No API key applied</div>`}
    </div>
...
`:void 0}function oR(e){if(this.resolvedSpec.securitySchemes&&e){const t=[];return e.forEach((e=>{const r=[],n=[];Object.keys(e).forEach((t=>{let a="";const o=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===t));e[t]&&Array.isArray(e[t])&&(a=e[t].join(", ")),o&&(n.push(o.typeDisplay),r.push({...o,scopes:a}))})),t.push({securityTypes:n.length>1?`${n[0]} + ${n.length-1} more`:n[0],securityDefs:r})})),D`<div style="position:absolute; top:3px; right:2px; font-size:var(--font-size-small); line-height: 1.5;">
  ...
  <div class="tab-panel col"
  ...
  </section>`}function sR(e){return D`
    ...
    `))}
  `}const lR={},cR=qP(class extends UP{constructor(){super(...arguments),this.nt=lR}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.nt)&&this.nt.length===t.length&&t.every(((e,t)=>e===this.nt[t])))return F}else if(this.nt===t)return F;return this.nt=Array.isArray(t)?Array.from(t):t,this.render(t,r)}}),{H:pR}=X,uR={},dR=qP(class extends UP{constructor(e){if(super(e),e.type!==NP&&e.type!==DP&&e.type!==zP)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===F||t===N)return t;const r=e.element,n=e.name;if(e.type===NP){if(t===r[n])return F}else if(e.type===zP){if(!!t===r.hasAttribute(n))return F}else if(e.type===DP&&r.getAttribute(n)===t+"")return F;return((e,t=uR)=>{e._$AH=t})(e),t}}),hR=l`
.border-top {
  border-top:1px solid var(--border-color);
}
.border{
...
`;customElements.define("schema-tree",class extends ne{static get properties(){return{data:{type:Object},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[We,CR,hR,l`
      ...
      <div class="tree ${"true"===this.schemaDescriptionExpanded?"expanded-descr":"collapsed-descr"}">
        ...
        ${null!==(r=this.data)&&void 0!==r&&r["::description"]?D`<span class='m-markdown'> ${HP(Ue(this.data["::description"]||""))}</span>`:""}
        ${this.data?D`
    ...
    `}generateTree(e,t="object",r="",n="",a="",o=0,i=0,s=""){var l;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return D`<div class="null" style="display:inline;">
      ...
      <div class = "tr primitive" title="${A?"Deprecated":""}">
        ...
        <div class='td key-descr'>
          ${"array"===t?D`<span class="m-markdown-small">${HP(Ue(a))}</span>`:""}
          ${k?D`<span class="m-markdown-small">
                ${HP(Ue(`${S?`**${S}:**`:""} ${k} ${b||x||w||$?"⤵":""}`))}
              </span>`:S?D`${S} ${b||x||w||$?"⤵":""}`:""}
          ...
          ${$?D`<div style='display:inline-block; line-break: anywhere; margin-right:8px'><span class='bold-text'>Pattern: </span>${$}</div>`:""}
        </div>
      </div>
    ...
    `]}});customElements.define("api-request",class extends ne{constructor(){super(),this.responseMessage="",this.responseStatus="success",this.responseHeaders="",this.responseText="",this.responseUrl="",this.curlSyntax="",this.activeResponseTab="response",this.requestBodyRenderStyle="default",this.selectedRequestBodyType="",this.selectedRequestBodyExample="",this.activeParameterSchemaTabs={}}static get properties(){return{serverUrl:{type:String,attribute:"server-url"},servers:{type:Array},method:{type:String},path:{type:String},security:{type:Array},parameters:{type:Array},request_body:{type:Object},api_keys:{type:Array},parser:{type:Object},accept:{type:String},callback:{type:String},requestBodyRenderStyle:{type:String,attribute:"request-body-render-style"},responseMessage:{type:String,attribute:!1},responseText:{type:String,attribute:!1},responseHeaders:{type:String,attribute:!1},responseStatus:{type:String,attribute:!1},responseUrl:{type:String,attribute:!1},fillRequestFieldsWithExample:{type:String,attribute:"fill-request-fields-with-example"},useSummaryToListExamples:{type:String,attribute:"use-summary-to-list-example"},allowTry:{type:String,attribute:"allow-try"},hideTryMetadata:{type:Boolean,attribute:"hide-try-metadata"},renderStyle:{type:String,attribute:"render-style"},schemaStyle:{type:String,attribute:"schema-style"},activeSchemaTab:{type:String,attribute:"active-schema-tab"},activeParameterSchemaTabs:{type:Object,converter:{fromAttribute:e=>JSON.parse(e),toAttribute:e=>JSON.stringify(e)},attribute:"active-parameter-schema-tabs"},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},fetchCredentials:{type:String,attribute:"fetch-credentials"},activeResponseTab:{type:String},selectedRequestBodyType:{type:String,attribute:"selected-request-body-type"},selectedRequestBodyExample:{type:String,attribute:"selected-request-body-example"}}}static get styles(){return[Ke,Ve,We,Ge,hR,Ze,Ye,l`
        *, *:before, *:after { box-sizing: border-box; }
      ...
      <tr title="${r.deprecated?"Deprecated":""}"> 
        <td rowspan="${"true"===this.allowTry?"1":"2"}" style="width:${d}; min-width:100px;">
          <div class="param-name ${r.deprecated?"deprecated":""}" >
            ${r.deprecated?D`<span style='color:var(--red);'>✗</span>`:""}
            ${r.required?D`<span style='color:var(--red)'>*</span>`:""}
            ${r.name}
          </div>
    ...
    <div style="display:block; overflow-x:auto; max-width:100%;">
      ...
      `,o.forEach((e=>{let o,i=[];if(this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose"))e.mimeType===this.selectedRequestBodyType&&(i=ER(e.schema,e.mimeType,e.examples,e.example,!1,!0,"text",!1),this.selectedRequestBodyExample||(this.selectedRequestBodyExample=i.length>0?i[0].exampleId:""),a=D`
            ${a}
            <div class = 'example-panel border-top pad-top-8'>
              ...
              ${i.filter((e=>e.exampleId===this.selectedRequestBodyExample)).map((t=>D`
                <div class="example ${t.exampleId===this.selectedRequestBodyExample?"example-selected":""}" data-example = '${t.exampleId}'>
                  ...
                  ${t.exampleDescription?D`<div class="m-markdown-small" style="padding: 4px 0"> ${HP(Ue(t.exampleDescription||""))} </div>`:""}
          ...
          `);(e.mimeType.includes("json")||e.mimeType.includes("xml")||e.mimeType.includes("text")||this.selectedRequestBodyType.includes("jose"))&&(o=AR(e.schema,{}),"table"===this.schemaStyle?n=D`
            ${n}
            <schema-table
      ...
      <div class='request-body-container' data-selected-request-body-type="${this.selectedRequestBodyType}">
        ...
        ${this.request_body.description?D`<div class="m-markdown" style="margin-bottom:12px">${HP(Ue(this.request_body.description))}</div>`:""}
        
        ${this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose")?(()=>{switch(this.requestBodyRenderStyle){case"splitted":return D`
    ...
    `}formDataParamAsObjectTemplate(e,t,r){var n;const a=AR(t,{}),o=ER(t,"json",t.examples,t.example,!1,!0,"text",!1);return D`
    ...
    `}formDataTemplate(e,t,r=""){const n=[];if(e.properties){for(const r in e.properties){var a,o;const i=e.properties[r];if(i.readOnly)continue;const s=i.examples||i.example||"",l=i.type,c=fR(i),p="read focused".includes(this.renderStyle)?"200px":"160px",u=yR(c.examples||c.example,c.type);n.push(D`
      ...
      <textarea
        ...
        style="width:100%"
      ></textarea>
      ${e.description?D`<span class="m-markdown-small">${HP(Ue(e.description))}</span>`:""}
      ...
      <div class="tab-panel col" style="border-width:0 0 1px 0;">
        ...
        ${this.responseIsBlob?D`
            ...
            <div class="tab-content col m-markdown" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};" >
              ...
              <pre style="white-space:pre; min-height:50px; height:max-content; resize:vertical; overflow:auto">${e?D`<code>${HP(He().highlight(this.responseText,He().languages[e],e))}</code>`:`${this.responseText}`}</pre>
            </div>`}
    ...
    `}generateTree(e,t="object",r="",n="",a="",o=0,i=0,s=""){var l,c;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return D`<div class="null" style="display:inline;">
        ...
        <span class="key-label xxx-of-key"> ${n.replace("::OPTION~","")}</span>
        ${"array"===t?D`<span class='mono-font'> [ ] </span>`:"object"===t?D`<span class='mono-font'> { } </span>`:D`<span class='mono-font'> schema undefined </span>`}
      </div>`;const p=null!==(l=e["::type"])&&void 0!==l&&l.startsWith("xxx-of")?o:o+1,u="xxx-of-option"===t||"xxx-of-option"===e["::type"]||n.startsWith("::OPTION")?i:i+1,d=16*u;if(0===Object.keys(e).length)return D`<span class="td key object" style='padding-left:${d}px'>${n}</span>`;let h="",f="",m=!1;if(n.startsWith("::ONE~OF")||n.startsWith("::ANY~OF"))h=n.replace("::","").replace("~"," "),m=!0;else if(n.startsWith("::OPTION")){const e=n.split("~");h=e[1],f=e[2]}else h=n;let y="";if("object"===e["::type"]?y="array"===t?"array of object":"object":"array"===e["::type"]&&(y="array"===t?"array of array "+("object"!==r?`of ${r}`:""):"array"),"object"==typeof e)return D`
        ${p>=0&&n?D`
    ...
    ${e.description?D`<div class="m-markdown"> ${HP(Ue(e.description))}</div>`:""}
...
`:""}function PR(e){return D`
  ...
  ${this.resolvedSpec.components.map((e=>D`
    ...
    `))}
`:""}function BR(){const e=new Ue.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function DR(){var e,t,r,n;return D`
  ...
  `}function FR(e){var t;const r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.find((t=>t.url===e));return!!r&&(this.selectedServer=r,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:r}})),!0)}function NR(e,t){const r=[...e.currentTarget.closest("table").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{const t=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(t,e.value)})),t.computedUrl=n,this.requestUpdate()}function zR(){return this.selectedServer&&this.selectedServer.variables?D`
    ...
    <table class='m-table'>
      ${Object.entries(this.selectedServer.variables).map((e=>D`
        ...
        ${e[1].description?D`<tr><td colspan="2" style="border:none"><span class="m-markdown-small"> ${HP(Ue(e[1].description))} </span></td></tr>`:""}
      `))}
    </table>
    `:""}function qR(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":D`
...
`}function VR(e){const t=new Ue.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function GR(e){return D`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function KR(){var e;if("true"===this.showInfo)return GR(DR.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return GR(t&&r?jR.call(this,r,t.name):"")}function JR(e){return D`
  ...
  `}function YR(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,a=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=DR.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=aR.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=qR.call(this);else if("operations-top"===e)t=D`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=LR.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;n=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=n?GR.call(this,JR.call(this,n)):KR.call(this)}else{for(a=0;a<this.resolvedSpec.tags.length&&(n=this.resolvedSpec.tags[a],r=this.resolvedSpec.tags[a].paths.find((t=>`${t.elementId}`===e)),!r);a+=1);if(r){UR(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=GR.call(this,jR.call(this,r,n.name))}else t=KR.call(this)}return t}function ZR(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${"#"===this.routePrefix?"":`${this.routePrefix}`}`);else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${t}`)}this.requestUpdate()}function QR(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function XR(e,t="expand-all"){QR.call(this,e.target.closest(".operations-root"),t)}function eL(e,t=!1){return D`
    ...
    `}responseHeaderListTemplate(e){return D`
      ...
      ${1===e.examples.length?D`
          ${"json"===e.examples[0].exampleFormat?D`
              ...
              ${e.examples[0].exampleDescription?D`<div class="m-markdown-small" style="padding: 4px 0"> ${HP(Ue(e.examples[0].exampleDescription||""))} </div>`:""}
              <json-tree 
                render-style = '${this.renderStyle}'
...
`;function oL(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),D`
  ...
  *, *:before, *:after { box-sizing: border-box; }
          ...
          ${!0===this.loading?D`<div class="loader"></div>`:D`
              ${!0===this.loadFailed?D`<div style="text-align: center;margin: 16px;"> Unable to load the Spec</div>`:D`
                  ...
                  ${"focused"===this.renderStyle?D`${YR.call(this)}`:D`
                      ...
                      ${"true"===this.allowServerSelection?qR.call(this):""}
  ...
  `}function hL(){return D`
    ...
    ${this.resolvedSpec.schemaAndExamples.map((e=>{var t;const r=ER(e.schema,"json",e.examples,e.example,!0,!1,"json",!0);return e.selectedExample=null===(t=r[0])||void 0===t?void 0:t.exampleId,D`
